...
// This uses https://github.com/jhudson8/backbone-query-parameters/commit/8908a31af01c2507eff97014f2a7db88745e1433
// with the patch from https://github.com/Factlink/core/commit/d8070b1201419f16ef3169c161ec2363a77f8dde
  ...
  getQueryParameters: function(fragment, forcePushState) {
    ...
    if (match) {
      ...
      iterateQueryString(queryString, function(name, value) {
        value = decodeURIComponentPlus(value);
        if (!rtn[name]) {
          rtn[name] = value;
  ...
  _extractParameters: function(route, fragment) {
    ...
    for (var i=0; i<length; i++) {
      if (_.isString(params[i])) {
        params[i] = decodeURIComponentPlus(params[i]);

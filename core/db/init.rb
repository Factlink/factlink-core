...
LoadDsl.load do
  ...
  user "tomdev"
    fact_relation "the molecules that are not accessible to microbes persist and could have toxic effects", :believes, "Oil is still detrimental to the environment,"
      believers "merijn","tomdev","jjoos"
      disbelievers "remon","martijn"
    fact_relation "Oil that is consumed by microbes \"is being converted to carbon dioxide that still gets into the atmosphere.\"", :believes, "Oil is still detrimental to the environment,"
      doubters "tomdev"
    fact_relation "Microbes had the metabolic potential to break down a large portion of hydrocarbons and keep up with the flow rate from the wellhead", :disbelieves, "Oil is still detrimental to the environment,"
      believers "tomdev"
    fact_relation "the molecules that are not accessible to microbes persist and could have toxic effects", :believes, "Cook served as Apple CEO for two months in 2004, when Jobs was recovering from pancreatic cancer surgery. In 2009, Cook again served as Apple CEO for several months while Jobs took a leave of absence for a liver transplant."
      disbelievers "tomdev"
    fact_relation "Cook served as Apple CEO for two months in 2004, when Jobs was recovering from pancreatic cancer surgery. In 2009, Cook again served as Apple CEO for several months while Jobs took a leave of absence for a liver transplant.", :believes, "Molecules that are not accessible to microbes persist and could have toxic effects"
      disbelievers "tomdev"
    fact_relation "Microbes had the metabolic potential to break down a large portion of hydrocarbons and keep up with the flow rate from the wellhead", :believes, "Molecules that are not accessible to microbes persist and could have toxic effects"
      believers "tomdev"
    fact_relation "Cook served as Apple CEO for two months in 2004, when Jobs was recovering from pancreatic cancer surgery. In 2009, Cook again served as Apple CEO for several months while Jobs took a leave of absence for a liver transplant.", :believes, "the molecules that are not accessible to microbes persist and could have toxic effects"
      disbelievers "tomdev"
    fact_relation "Cook served as Apple CEO for two months in 2004, when Jobs was recovering from pancreatic cancer surgery. In 2009, Cook again served as Apple CEO for several months while Jobs took a leave of absence for a liver transplant.", :believes, "Most bacterial infections can be treated with antibiotics such as penicillin, discovered decades ago. However, such drugs are useless against viral infections"
      disbelievers "tomdev"

  user "jjoos"
    fact_relation "When viruses infect a cell, they take over its cellular machinery for their own purpose -- that is, creating more copies of the virus.", :believes, ". Google plans to shut down the social applications developed by Slide, a company it acquired a year ago for US$182 million."
      believers "jjoos"
    fact_relation "Most bacterial infections can be treated with antibiotics such as penicillin, discovered decades ago. However, such drugs are useless against viral infections", :disbelieves, ". Google plans to shut down the social applications developed by Slide, a company it acquired a year ago for US$182 million."
      believers "jjoos"
    fact_relation "Obesity is growing at alarming rates worldwide, and the biggest culprit is overeating", :believes, ". Google plans to shut down the social applications developed by Slide, a company it acquired a year ago for US$182 million."
      believers "jjoos"
    fact_relation ". Google plans to shut down the social applications developed by Slide, a company it acquired a year ago for US$182 million.  ", :believes, "Obesity is growing at alarming rates worldwide, and the biggest culprit is overeating"
      believers "jjoos"
    fact_relation " New Depiction of Light Could Boost Telecommunications Channels Physicists have presented a new way to map spiraling light that could help harness untapped data channels in optical fibers. Increased bandwidth would ease the burden on fiber-optic telecommunications networks taxed ...  > full story more on: Optics; Graphene; Inorganic Chemistry; Chemistry; Physics; Computer Modeling ", :believes, " First Glimpse Into Birth of the Milky Way For almost 20 years astrophysicists have been trying to recreate the formation of spiral galaxies such as our Milky Way realistically. Now astrophysicists and astronomers present the world's first realistic simulation of the ...  > full story more on: Galaxies; Astrophysics; Stars; Astronomy; Dark Matter; Solar System "
      believers "jjoos"
    fact_relation ". Google plans to shut down the social applications developed by Slide, a company it acquired a year ago for US$182 million.  ", :disbelieves, " First Glimpse Into Birth of the Milky Way For almost 20 years astrophysicists have been trying to recreate the formation of spiral galaxies such as our Milky Way realistically. Now astrophysicists and astronomers present the world's first realistic simulation of the ...  > full story more on: Galaxies; Astrophysics; Stars; Astronomy; Dark Matter; Solar System "
      believers "jjoos"
    fact_relation ". Google plans to shut down the social applications developed by Slide, a company it acquired a year ago for US$182 million.", :believes, " First Glimpse Into Birth of the Milky Way For almost 20 years astrophysicists have been trying to recreate the formation of spiral galaxies such as our Milky Way realistically. Now astrophysicists and astronomers present the world's first realistic simulation of the ...  > full story more on: Galaxies; Astrophysics; Stars; Astronomy; Dark Matter; Solar System "
      believers "jjoos"
    fact_relation "The plant Arabidopsis thaliana is found throughout the entire northern hemisphere", :believes, " First Glimpse Into Birth of the Milky Way For almost 20 years astrophysicists have been trying to recreate the formation of spiral galaxies such as our Milky Way realistically. Now astrophysicists and astronomers present the world's first realistic simulation of the ...  > full story more on: Galaxies; Astrophysics; Stars; Astronomy; Dark Matter; Solar System "
      believers "jjoos"
    fact_relation "Obesity is growing at alarming rates worldwide, and the biggest culprit is overeating", :believes, " First Glimpse Into Birth of the Milky Way For almost 20 years astrophysicists have been trying to recreate the formation of spiral galaxies such as our Milky Way realistically. Now astrophysicists and astronomers present the world's first realistic simulation of the ...  > full story more on: Galaxies; Astrophysics; Stars; Astronomy; Dark Matter; Solar System "
      believers "jjoos"
    fact_relation "De veiligheid van liften in Nederland is in gevaar doordat vier van de zes bedrijven die liften mogen keuren niet onafhankelijk zijn van hun opdrachtgevers. ", :believes, "Stanford microsurgeons have used a poloxamer gel and bioadhesive, rather than a needle and thread, to join together blood vessels"
      believers "jjoos"
    fact_relation "Stanford microsurgeons have used a poloxamer gel and bioadhesive, rather than a needle and thread, to join together blood vessels", :disbelieves, "\"On earth, nuclear reactors are under attack because of concerns over damage caused by natural disasters. In space, however, nuclear technology may get a new lease on life."
      believers "jjoos"
    fact_relation "De veiligheid van liften in Nederland is in gevaar doordat vier van de zes bedrijven die liften mogen keuren niet onafhankelijk zijn van hun opdrachtgevers. ", :believes, "\"On earth, nuclear reactors are under attack because of concerns over damage caused by natural disasters. In space, however, nuclear technology may get a new lease on life."
      believers "jjoos"
    fact_relation ". Google plans to shut down the social applications developed by Slide, a company it acquired a year ago for US$182 million.  ", :believes, "\"On earth, nuclear reactors are under attack because of concerns over damage caused by natural disasters. In space, however, nuclear technology may get a new lease on life."
      believers "jjoos"

require File.expand_path('../../../../app/interactors/fact_doubters_interactor.rb', __FILE__)

describe FactDoubtersInteractor do
  it 'initializes correctly' do
    interactor = FactDoubtersInteractor.new 1, 0, 3, current_user: mock
    interactor.should_not be_nil
  end

  it 'gives an authorized error when there isn''t a logged in user' do
    expect { FactDoubtersInteractor.new 1, 0, 3 }.
  ...
  describe '.execute' do
    ...
    it 'correctly' do
      ...
      results = FactDoubtersInteractor.perform fact_id, skip, take, current_user: user

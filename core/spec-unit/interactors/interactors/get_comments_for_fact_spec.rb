...
require_relative '../../../app/interactors/interactors/get_comments_for_fact.rb'

describe Interactors::GetCommentsForFact do
  include PavlovSupport

  it 'initializes corretly' do
    interactor = Interactors::GetCommentsForFact.new 1, 'believes', current_user: mock()
    interactor.should_not be_nil
  end

  it 'with an invalid fact_id should raise a validation error' do
    expect { Interactors::GetCommentsForFact.new 'a', 'believes', current_user: mock()}.
  ...
  it 'with an invalid opinion should raise a validation error' do
    expect { Interactors::GetCommentsForFact.new 1, 'mwah', current_user: mock()}.
  ...
  it 'without a current_user should raise a access error' do
    expect { Interactors::GetCommentsForFact.new 1, 'believes' }.
  ...
  describe '.execute' do
    it 'correctly' do
      ...
      opinion = 'believes'
      user = mock()
      interactor = Interactors::GetCommentsForFact.new fact_id, opinion, current_user: user

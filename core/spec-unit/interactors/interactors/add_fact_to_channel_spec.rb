...
require_relative '../../../app/interactors/interactors/add_fact_to_channel.rb'

describe Interactors::AddFactToChannel do
  ...
  it 'raises when executed without any permission' do
    ...
    interactor = Interactors::AddFactToChannel.new '1', '1', ability: ability
  ...
  describe '.execute' do
    context 'when properly initialized' do
      it 'executes correctly' do
        ...
        interactor = Interactors::AddFactToChannel.new fact_id, channel_id, ability: relaxed_ability
        interactor.execute
      end
    end
  end

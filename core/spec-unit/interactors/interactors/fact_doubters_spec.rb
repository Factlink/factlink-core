require_relative '../../../app/interactors/interactors/fact_doubters.rb'

describe Interactors::FactDoubters do
  it 'initializes correctly' do
    interactor = Interactors::FactDoubters.new 1, 0, 3, current_user: mock
    interactor.should_not be_nil
  end

  it 'gives an authorized error when there isn''t a logged in user' do
    expect { Interactors::FactDoubters.new 1, 0, 3 }.

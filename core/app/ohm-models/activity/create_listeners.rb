...
class ActivityListenerCreator
  ...
  def only_users_that_see_channels user_ids
    user_ids.keep_if do |id|
  ...
  def create_activity_listeners
    ...
    forGraphUser_someone_followed_your_channel = {
      ...
      write_ids: lambda { |a| only_users_that_see_channels([a.subject.created_by_id]) }
    }
    ...
    forGraphUser_someone_of_whom_you_follow_a_channel_created_a_new_channel = {
      ...
      write_ids: lambda { |a| only_users_that_see_channels(reject_self(channel_followers_of_graph_user_minus_regular_followers(a.subject.created_by),a)) }
    }

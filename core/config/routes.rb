FactlinkUI::Application.routes.draw do
  ...
  get "/auth/:provider_name/callback" => "social_accounts#service_callback", as: "social_auth"
  delete "/auth/:provider_name/deauthorize" => "social_accounts#service_deauthorize"

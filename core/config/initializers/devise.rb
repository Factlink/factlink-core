...
Devise.setup do |config|
  ...
  config.confirm_within = 1.month # NOTE (JP): Required because we keep confirmation tokens around
                                  # See our Users::ConfirmationController#restore_confirmation_token

...
describe 'window.collectionDifference', ->
  ...
  it 'should work when setting an attribute of a model in "collection1"', ->
    ...
    expect(result.pluck('someField')).to.deep.equal([1, 4, 20])
  ...
  it 'should ignore other fields', ->
    ...
    expect(result.pluck('otherField')).to.deep.equal([10])

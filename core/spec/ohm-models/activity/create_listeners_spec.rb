...
describe 'activity queries' do
    ...
    context "creating a comment" do
      ...
      it "creates a stream activity for the user's followers" do
        ...
        as(gu1.user) do |pavlov|
          pavlov.interactor(:'users/follow_user', username: gu1.user.username, user_to_follow_username: user.username)
        end
    ...
    context "creating a sub comment on a comment" do
      context "gu1 believes the topfact" do
        ...
        it "creates a stream activity for the user's followers" do
          ...
          as(gu1.user) do |pavlov|
            pavlov.interactor(:'users/follow_user', username: gu1.user.username, user_to_follow_username: current_user.username)
          end
  ...
  describe 'following a person' do
    ...
    it 'creates a notification for the followed person' do
      as(user) do |pavlov|
        pavlov.interactor(:'users/follow_user', username: user.username, user_to_follow_username: followee.username)
      end
    ...
    it 'creates a stream activity for your followers' do
      ...
      as(follower) do |pavlov|
        pavlov.interactor(:'users/follow_user', username: follower.username, user_to_follow_username: user.username)
      end
      as(user) do |pavlov|
        pavlov.interactor(:'users/follow_user', username: user.username, user_to_follow_username: followee.username)
      end

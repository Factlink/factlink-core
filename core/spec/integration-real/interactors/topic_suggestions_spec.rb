  ...
  describe 'are returned' do
    it 'in the correct order' do
      as(user) do |pavlov|
        ...
        top_suggestion   = pavlov.command :'channels/create', 'top-suggestion'
        loser_suggestion = pavlov.command :'channels/create', 'loser-suggestion'

        pavlov.interactor  :'channels/add_fact', fact1, top_suggestion
        pavlov.interactor  :'channels/add_fact', fact1, loser_suggestion
        pavlov.interactor  :'channels/add_fact', fact2, top_suggestion

...
describe ElasticSearchDeleteFactDataForTextSearch do
  def fake_class
    Class.new
  end
  ...
  it 'intitializes' do
    interactor = ElasticSearchDeleteFactDataForTextSearch.new fact_data

    interactor.should_not be_nil
  end

  it 'raises when fact_data is not a FactData' do
    expect { interactor = ElasticSearchDeleteFactDataForTextSearch.new 'FactData' }.

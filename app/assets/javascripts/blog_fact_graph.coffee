# Marionette from https://github.com/marionettejs/backbone.marionette/blob/78057aaa898aabb2751f60723ee1bcdf9f4f7f34/lib/backbone.marionette.min.js
...
# Raphael from https://github.com/DmitryBaranovskiy/raphael/blob/076969f21d02df9ca72dcf7d1bfa31ae17f3b9d3/raphael-min.js
...
asyncChecking = (test, func, thisArg=null, timeout=100, dt=3) ->
...
class TextView extends Marionette.ItemView
  template: (attributes) -> attributes.text
  tag: 'span'
...
class CrossFadeRegion extends Marionette.Region
...
class PositionedRegion extends CrossFadeRegion
  ...
  updatePosition: ->
    if @currentView?
      @_asyncChecker =
        asyncChecking @_visible, @_actuallyUpdatePosition, @
...
class TooltipOpener extends Marionette.View
  modelEvents:
  ...
  _renderTooltip: ->
    ...
    @_positionedRegion = new PositionedRegion region_options
...
makeTooltipForView = (parentView, options) ->
  _.defaults options,
    $offsetParent: parentView.$el
    $tooltipElement: parentView.$(options.selector)

  tooltipOpener = new TooltipOpener options
